...
const CodeNavBar = ({
    ...
    const { data: pollData, isFetching } = useQuery({
        ...
        onSuccess: (data) => {
            ...
            if (!enums?.enums?.CQEvaluationStatus || !enums?.enums?.CQEvaluationResult) {
                return;
            }
            ...
            console.log('Status:', status, 'COMPLETED:', COMPLETED, 'ERROR:', ERROR);
            ...
            if (status === COMPLETED || status === ERROR) {
                ...
                const resultText = data.evaluation_result ? Object.keys(enums.enums.CQEvaluationResult).find(
                    (key) => enums.enums.CQEvaluationResult[key] === data.evaluation_result
                ) : null;
