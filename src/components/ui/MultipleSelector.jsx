    ...
    (
        ...
        return (
            ...
            >
                ...
                >
                    <div className="relative flex flex-wrap gap-1 items-center w-full">
                        {selected.map(option => {
                            return (
                                <Badge
                                    key={option.value}
                        ...
                        />
                        {/* ChevronDown icon only when nothing is selected */}
                        {selected.length === 0 && (
                            <ChevronDown className="size-4 my-auto text-greyPrimary mr-3 absolute right-2 top-1/2 -translate-y-1/2 pointer-events-none" />
                        )}
                        {/* X icon only when something is selected */}
                        {selected.length > 0 && (
                            <button
                                type="button"
                                onClick={() => {
                                ...
                                className={cn(
                                    "absolute right-2 top-1/2 -translate-y-1/2 h-6 w-6 p-0 flex items-center justify-center"
                                )}
                            >
                                <X className="size-5 text-greyPrimary" />
                            </button>
                        )}
                    </div>
                </div>
